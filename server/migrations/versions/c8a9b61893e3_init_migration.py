...
Revision ID: c8a9b61893e3
Revises: 
Create Date: 2025-04-09 22:02:44.527625
...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['problem_id'], ['problem.id'], name=op.f('fk_downvote_solution_problem_id_problem'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['solution_id'], ['solution.id'], name=op.f('fk_downvote_solution_solution_id_solution'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('fk_downvote_solution_user_id_user'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_downvote_solution')),
    sa.UniqueConstraint('user_id', 'solution_id', name=op.f('uq_downvote_solution_user_id'))
    )
    with op.batch_alter_table('downvote_solution', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_downvote_solution_created_at'), ['created_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_downvote_solution_updated_at'), ['updated_at'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['problem_id'], ['problem.id'], name=op.f('fk_upvote_solution_problem_id_problem'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['solution_id'], ['solution.id'], name=op.f('fk_upvote_solution_solution_id_solution'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('fk_upvote_solution_user_id_user'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_upvote_solution')),
    sa.UniqueConstraint('user_id', 'problem_id', name=op.f('uq_upvote_solution_user_id'))
    )
    with op.batch_alter_table('upvote_solution', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_upvote_solution_created_at'), ['created_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_upvote_solution_updated_at'), ['updated_at'], unique=False)
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('upvote_solution', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_upvote_solution_updated_at'))
        batch_op.drop_index(batch_op.f('ix_upvote_solution_created_at'))
    ...
    with op.batch_alter_table('downvote_solution', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_downvote_solution_updated_at'))
        batch_op.drop_index(batch_op.f('ix_downvote_solution_created_at'))
